...
#
# USO:
#   python run_scraping.py                    # Ejecutar todos los scrapers
...
def ejecutar_scraper(modulo_nombre: str, clase_nombre: str,
    ...
    Retorna un dict con resultado de la ejecución.
    """
    resultado = {
        "fuente":    fuente,
        "exito":     False,
    ...
    try:
        ...
        # Agregar el directorio de scrapers al path de Python
...
def main():
    ...
    if not args.solo_consolidar:
        ...
        for modulo, clase, fuente, _ in scrapers_a_ejecutar:
            resultado = ejecutar_scraper(modulo, clase, fuente)
    ...
    if resultados_scrapers:
        ...
        for r in resultados_scrapers:
            ...
            logger.info(f"    {estado} {r['fuente']:15} | "
                        f"ofertas={r['ofertas']:,} | "
